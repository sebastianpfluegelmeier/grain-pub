/* @ts-self-types="./grain_audio_wasm.d.ts" */

export class WorkletEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WorkletEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_workletengine_free(ptr, 0);
    }
    /**
     ...
     */
    clear_plan() {
        wasm.workletengine_clear_plan(this.__wbg_ptr);
    }
    /**
     * @returns {boolean}
     */
    has_plan() {
        const ret = wasm.workletengine_has_plan(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    constructor(sample_rate_hz) {
        const ret = wasm.workletengine_new(sample_rate_hz);
        this.__wbg_ptr = ret >>> 0;
        WorkletEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    sample_rate() {
        const ret = wasm.workletengine_sample_rate(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    set_plan_json(plan_json) {
        const ptr0 = passStringToWasm0(plan_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.workletengine_set_plan_json(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./grain_audio_wasm_bg.js": import0,
    };
}

const WorkletEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_workletengine_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('grain_audio_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
